...
typedef struct
{
    Nvic_InterruptsType vector;     // name from Nvic_InterruptsType in IntCtlc.h
    uint32 groupPriority;           // Group priorities set according to PRI_Group
    uint32 subGroupPriority;        // Subgroup priorities set according to PRI_Group
} NVIC_ConfigType;
